...
<div>
    <div style="display:flex; margin-top: 5px;">
        <img src = "static\images\img_thingworx\unnamed.jpg" width = "80" hspace = "0">

        <p style="font-family:Acumin Pro Extra Light; color:#323b42; font-size:40px; margin-left: 20px; margin-top: 10px;">
            thingworx
        </p>
    </div>
    <hr>
...
<div style="display:block">
    <div>
        ...
        <p style = "margin-top: 30px; font-family:Acumin Pro Extra Light; color:#323b42; font-size:30px;">
            Introduction to thingworx
        </p>
    </div>
    <div style = "margin-top: 10px; font-family:Acumin Pro Extra Light; color:#323b42; font-size:20px; align="justify";">
        <p>
    ...
    <div align="center">
        ...
        <p style = "margin-top: 10px; font-family:Acumin Pro Extra Light; color:#323b42; font-size:30px;">
            Specifications 
        </p>
    </div>
    ...
    <div style="margin-top: 30px; font-family:Acumin Pro Extra Light; color:#323b42; font-size:20px; align="justify";">   
        <button style="display: block; width: 100%; border: none; background-color: #5ab63a; padding: 7px 14px; 
            ...
            <a href="https://www.irisoft.ru/portfolio/?_front_software=thingworx" style="color: white; font-size:20px" >
...
<div style="display:flex; align="justify";">
    <div style="width: 50%;">
        ...
        <p style="font-family:Acumin Pro Extra Light; color:#323b42; font-size:20px; margin-left: 20px; margin-top: 10px;">
...
<div style="display:flex; align="justify";">
    <div style="width: 50%;">
        ...
        <img src = "static\images\img_thingworx\b3.png" width = "40" hspace = "0" style="margin-top: 10px;">
    ...
    <div style="width: 50%;">
        ...
        <img src = "static\images\img_thingworx\b4.png" width = "40" hspace = "0" style="margin-top: 10px;">
...
<div style="display:flex; align="justify";">
    <div style="width: 50%;">
        ...
        <img src = "static\images\img_thingworx\b5.png" width = "40" hspace = "0" style="margin-top: 10px;">
    ...
    <div style="width: 50%;">
        ...
        <img src = "static\images/img_thingworx\b6.png" width = "40" hspace = "0" style="margin-top: 10px;">
